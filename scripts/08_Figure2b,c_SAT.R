###############################################################################
# Script name: 06_Figure2b,c_SAT.R
#
# Description:
# This script performs T‑cell receptor (TCR) repertoire analysis for SAT
...
#  - Loading SAT‑derived TCR contig annotation files
...
#
# All analyses in this script are restricted to SAT samples and focus on
...
#
# Purpose:
# To characterise SAT‑specific TCR repertoire structure and diversity across
...
ggsave(
 filename = "uniqueClonePercentSAT.svg",
 plot = ggp,              
 device = "svg",
...
ggsave(
 filename = "clonalDiversitySAT.svg",
