################################################################################
# Script name: 31_ExtendedDataFigure4_PBMC.R
#
# TCR Repertoire Gene Usage and Diversity in PBMC
#
# Analyses:
...
#
# Input:
#   • CellRanger TCR contig CSV files for PBMC
#
# Output:
...
ggsave(
 filename = "percentVGenesPBMCStagewise.pdf",
 plot = ggp,
 device = pdf,
...
ggsave(
 filename = "percentJGenesPBMCStagewise.pdf",
 plot = ggp,
 device = pdf,
 path = "~/plots/screpertoire/PBMC",
 width = 3,
...
ggsave(
  filename = "positionalEntropyPBMC.pdf",
  plot = ggp,              
  device = "pdf",
  path = "~/plots/screpertoire/PBMC",
  width = 5,                      
