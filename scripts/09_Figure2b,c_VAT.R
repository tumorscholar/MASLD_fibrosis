###############################################################################
# Script name: 06_Figure2b,c_VAT.R
#
# Description:
# This script performs T‑cell receptor (TCR) repertoire analysis for VAT
...
#  - Loading VAT‑derived TCR contig annotation files
...
#
# All analyses in this script are restricted to VAT samples and focus on
...
#
# Purpose:
# To characterise VAT‑specific TCR repertoire structure and diversity across
...
#Read files
#Healthy sample
s1 = read.csv("GC-WL-10742-SAT-VAT-PBMC_VAT_TCR_contig.csv")

#F0 samples
s2 = read.csv("GC-WL-9961-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s3 = read.csv("GC-WL-9999-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s4 = read.csv("GC-WL-10113-2-SAT-VAT-PBMC_VAT_TCR_contig.csv")

#F1 samples
s5 = read.csv("GC-WL-9680-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s6 = read.csv("GC-WL-10203-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s7 = read.csv("GC-WL-10113-1-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s8 = read.csv("GC-WL-10380-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s9 = read.csv("GC-WL-10291-2-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s10 = read.csv("GC-WL-10202-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s11 = read.csv("GC-WL-10634-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s12 = read.csv("GC-WL-10738-SAT-VAT-PBMC_VAT_TCR_contig.csv")

#F2 samples
s13 = read.csv("GC-WL-10205-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s14 = read.csv("GC-WL-9991-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s15 = read.csv("GC-WL-9932-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s16 = read.csv("GC-WL-11040-SAT-VAT-PBMC_VAT_TCR_contig.csv")

#F3 samples
s17 = read.csv("GC-WL-11051-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s18 = read.csv("GC-WL-11183-SAT-VAT-PBMC_VAT_TCR_contig.csv")
s19 = read.csv("GC-WL-11471-SAT-VAT-PBMC_VAT_TCR_contig.csv")

# F1 samples
s20 = read.csv("GC-WL-11327-SAT-VAT-PBMC_VAT_TCR_contig.csv")
...
ggsave(
 filename = "uniqueClonePercentVAT.svg",
 plot = ggp,              
 device = "svg",
 path = "~/plots/screpertoire/VAT",
 width = 3,                      
 height = 5,                     
 units = "in",
 dpi = 600                        
...
ggsave(
 filename = "clonalDiversityVAT.svg",
