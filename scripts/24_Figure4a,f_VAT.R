################################################################################
# Script name: 22_Figure4a,f_VAT.R
#
# CellChat visualisation and comparative analysis – VAT
#
# This script performs:
# - Loading of precomputed CellChat objects for VAT tissue
...
#
#   Input files:
# - cellchatVATTcHealthy.rds
# - cellchatVATTcNoFibrosis.rds
# - cellchatVATTcFibrosis.rds
#
#   Output files:
# - Differntial_interaction_strength_2D_VATTc.png
# - EndothelialTcSignallingVAT.svg
# - TcEndothelialSignallingVAT.svg
#
#   Notes:
...
cellchatH <- readRDS("/data/Blizard-AlazawiLab/rk/cellchat/VAT/sharedTcells/cellchatVATTcHealthy.rds")
...
ggsave("/data/Blizard-AlazawiLab/rk/cellchat/VAT/sharedTcells/Differntial_interaction_strength_2D_VATTc.png", dpi = 300, width = 18, height = 6)
...
# Save as SVG
svg("/data/Blizard-AlazawiLab/rk/cellchat/VAT/sharedTcells/EndothelialTcSignallingVAT.svg",
    width = 16, height = 5)
print(gg1)
dev.off()
...
# Save as SVG
svg("/data/Blizard-AlazawiLab/rk/cellchat/VAT/sharedTcells/TcEndothelialSignallingVAT.svg",
    width = 16, height = 5)
print(gg1)
dev.off()
