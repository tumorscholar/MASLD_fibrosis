###############################################################################
# Script name: 06_Figure2b,c_LIVER.R
#
# Description:
# This script performs T‑cell receptor (TCR) repertoire analysis for liver
...
#  - Loading liver‑derived TCR contig annotation files
...
#
# All analyses in this script are restricted to liver samples and focus on
...
#
# Purpose:
# To characterise liver‑specific TCR repertoire structure and diversity across
...
#Read files
#Healthy sample
s1 = read.csv("GC-WL-10742-LIVER_LIVER_TCR_contig.csv")

#F0 samples
s2 = read.csv("GC-WL-9961-LIVER_LIVER_TCR_contig.csv")
s3 = read.csv("GC-WL-9999-LIVER_LIVER_TCR_contig.csv")
s4 = read.csv("GC-WL-10113-2-LIVER_LIVER_TCR_contig.csv")

#F1 samples
s5 = read.csv("GC-WL-9680-LIVER_LIVER_TCR_contig.csv")
s6 = read.csv("GC-WL-10203-LIVER_LIVER_TCR_contig.csv")
s7 = read.csv("GC-WL-10113-1-LIVER_LIVER_TCR_contig.csv")
s8 = read.csv("GC-WL-10380-LIVER_LIVER_TCR_contig.csv")
s9 = read.csv("GC-WL-10291-2-LIVER_LIVER_TCR_contig.csv")
s10 = read.csv("GC-WL-10202-LIVER_LIVER_TCR_contig.csv")
s11 = read.csv("GC-WL-10634-LIVER_LIVER_TCR_contig.csv")
s12 = read.csv("GC-WL-10738-LIVER_LIVER_TCR_contig.csv")

#F2 samples
s13 = read.csv("GC-WL-10205-LIVER_LIVER_TCR_contig.csv")
s14 = read.csv("GC-WL-9991-LIVER_LIVER_TCR_contig.csv")
s15 = read.csv("GC-WL-9932-LIVER_LIVER_TCR_contig.csv")
s16 = read.csv("GC-WL-11040-LIVER_LIVER_TCR_contig.csv")

#F3 samples
s17 = read.csv("GC-WL-11051-LIVER_LIVER_TCR_contig.csv")
s18 = read.csv("GC-WL-11183-LIVER_LIVER_TCR_contig.csv")
s19 = read.csv("GC-WL-11471-LIVER_LIVER_TCR_contig.csv")

# F1 samples
s20 = read.csv("GC-WL-11327-LIVER_LIVER_TCR_contig.csv")
...
ggsave(
 filename = "uniqueClonePercentLiver.svg",
 plot = ggp,              
 device = "svg",
 path = "~/plots/screpertoire/liver",
 width = 3,                      
 height = 5,                     
 units = "in",
 dpi = 600                        
...
ggsave(
 filename = "clonalDiversityLiver.svg",
